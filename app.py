...
<h2 style='
    ...
    color: #5E17EB;
'>
SSS COLLEGE OF ARTS, SCIENCE AND MANAGEMENT COLLEGE
</h2>
""", unsafe_allow_html=True)
st.markdown(
    """
...
st.markdown(
    "<h3 style='text-align: center; color: #4169E1;'>PG Department of Computer Science</h3>",
    unsafe_allow_html=True
)
...
<h2 style='
    ...
    color: #121212;
    font-weight: 800;
    text-shadow: 0 0 8px #FF4B4B, 0 0 16px #FF0000;
'>
 DEBUGGING ROUND - 1 
</h2>
""", unsafe_allow_html=True)

st.caption(" **Instructions:** Do not refresh or switch tabs. If you tried to switch tabs or refresh the page, MCQ questions will auto-submit.")
